...
IL_0059:
	{
		...
		bool L_15;
		L_15 = Type_op_Equality_mE6EDDDC900C50B222CF32BCD2AD027595F2D74B7(G_B6_0, (Type_t*)NULL, NULL);
		if (L_15)
		{
			goto IL_00d3;
		}
...
IL_010b:
	{
		...
		MixedRealityPlayspace_set_Position_mED5CCC1D026F8B408FEB0BB6B7E9CFA04B3151B8(L_41, NULL);
		...
		MixedRealityPlayspace_set_Rotation_mAF52765F4364BD5DB07DA10B73EF2E8EF798AD2C(L_42, NULL);
		// if (CameraCache.Main.transform.position != Vector3.zero)
		Camera_tA92CC927D7439999BC82DBEDC0AA45B470F9E184* L_43;
		L_43 = CameraCache_get_Main_m631CABB7F5A697F4C1D76F7CB02D6791C0DDCB9E(NULL);
		NullCheck(L_43);
	...
	}
	{
		...
		String_t* L_51;
		L_51 = String_Format_m8C122B26BC5AA10E2550AECA16E57DAE10F07E30(_stringLiteral4FF56F0DB79ED48F92A89FC9BCCE0794BDA6075F, L_50, NULL);
		il2cpp_codegen_runtime_class_init_inline(Debug_t8394C7EEAECA3689C2C9B9DE9C7166D73596276F_il2cpp_TypeInfo_var);
...
IL_0153:
	{
		...
		L_52 = CameraCache_get_Main_m631CABB7F5A697F4C1D76F7CB02D6791C0DDCB9E(NULL);
		NullCheck(L_52);
		...
		bool L_56;
		L_56 = Quaternion_op_Inequality_mC1922F160B14F6F404E46FFCC10B282D913BE354_inline(L_54, L_55, NULL);
		if (!L_56)
		{
			goto IL_0178;
		}
