...
IL2CPP_EXTERN_C IL2CPP_METHOD_ATTR bool GenericXRSDKCameraSettings_get_IsOpaque_m67B764495219E1B8B0EC64BFDF5298D0AD7296CB (GenericXRSDKCameraSettings_tF9630B1F8A11581A51BEFE2C71E8D444D75052AB* __this, const RuntimeMethod* method) 
{
	...
	}
	{
		...
		L_1 = XRSubsystemHelpers_get_DisplaySubsystem_m8EAE61D2871CD20E9BDF90940031D5F3A368D14A(NULL);
		NullCheck(L_1);
		bool L_2;
	...
	}
	{
		...
		L_3 = XRSubsystemHelpers_get_DisplaySubsystem_m8EAE61D2871CD20E9BDF90940031D5F3A368D14A(NULL);
		NullCheck(L_3);
		bool L_4;
...
IL_0051_1:
			{
				...
				il2cpp_codegen_runtime_class_init_inline(SpatialAwarenessMeshObject_t5577B6C05F0A1138C582A8F1B7A717B81AE11379_il2cpp_TypeInfo_var);
				SpatialAwarenessMeshObject_Cleanup_mDC632004282E0A16833B4565C91FFBC524F08774(L_12, (bool)1, (bool)1, NULL);
				// }
				goto IL_0069;
			}
		}// end try (depth: 1)
...
IL_000a:
	...
	}
	{
		...
		il2cpp_codegen_runtime_class_init_inline(MixedRealityPose_tE60115C271AC50B8C11BA3B404BFCA99C7B2EFF5_il2cpp_TypeInfo_var);
		bool L_6;
		L_6 = MixedRealityPose_op_Inequality_mB46067EFA5311CB251EF504055B6E138F787CE24(L_4, L_5, NULL);
		if (!L_6)
		{
			goto IL_00be;
		}
	...
	}
	{
		...
		RuntimeObject* L_9;
		L_9 = CoreServices_get_InputSystem_m47147418643299159BF4DF408F768844FDC33943(NULL);
...
IL_0074_1:
			{
				...
				L_15 = MixedRealityPlayspace_TransformPoint_mF0F8AA899D9BBBA99FC4EBD1B8730F4174D15314(L_14, NULL);
				__this->___CurrentControllerPosition_14 = L_15;
				// CurrentControllerRotation = MixedRealityPlayspace.Rotation * rotation;
				Quaternion_tDA59F214EF07D7700B26E40E562F267AF7306974 L_16;
				L_16 = MixedRealityPlayspace_get_Rotation_mB5DCE6258ADE65064084A771A277AD2CDEC98737(NULL);
...
IL_001f_1:
			{
				...
				InputDevices_GetDevicesWithCharacteristics_m2F1785592FF66FB69D72FFE1C1B821D4BD64094A(L_3, L_4, NULL);
...
IL_0093:
	{
		...
		InputDevices_add_deviceConnected_m78FF855F70C572E7B9BFD5A591E2C5B023AB8728(L_15, NULL);
		...
		InputDevices_add_deviceDisconnected_m0E0638AF16C20B6408FD51EDF3F7F2914E81D7A9(L_16, NULL);
		// }
		return;
	}
}
